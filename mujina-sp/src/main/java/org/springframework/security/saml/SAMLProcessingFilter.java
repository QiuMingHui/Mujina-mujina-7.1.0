...
public class SAMLProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            ...
            log.info("Attempting SAML2 authentication using profile {}", getProfileName());
            ...
            HttpServletRequest httpRequest1 = ((HttpServletRequestAdapter)context.getInboundMessageTransport()).getWrappedRequest();
            String requestURL1 = DatatypeHelper.safeTrimOrNullString(httpRequest1.getRequestURL().toString());
            log.info("======requestURL1"+requestURL1);
            processor.retrieveMessage(context);
            HttpServletRequest httpRequest2 = ((HttpServletRequestAdapter)context.getInboundMessageTransport()).getWrappedRequest();
            String requestURL2 = DatatypeHelper.safeTrimOrNullString(httpRequest2.getRequestURL().toString());
            log.info("======requestURL2"+requestURL2);
