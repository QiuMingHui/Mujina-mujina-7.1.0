...
public class SAMLAuthenticationProvider implements AuthenticationProvider, InitializingBean {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        log.info("=======principal"+String.valueOf(principal));
        log.info("=======credential"+String.valueOf(credential));
        ...
        log.info("=======result.getName()"+String.valueOf(result.getName()));
        log.info("=======result.getPrincipal()"+String.valueOf(result.getPrincipal()));
